                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center gap-10">
                                    <div class="form-check form-check-custom form-check-solid form-check-sm">
                                        <input type="checkbox" name="is_filter" class="form-check-input" value="1" id="input-is-filter" @if($attribute->is_filter ?? false == '1') checked @endif/>
                                        <label class="form-check-label" for="input-is-filter">{{ trans('attribute::base.form.attribute.fields.is_filter.title') }}</label>
                                    </div>
                                    <div class="form-check form-check-custom form-check-solid form-check-sm">
                                        <input type="checkbox" name="is_special" class="form-check-input" value="1" id="input-is-special" @if($attribute->is_special ?? false == '1') checked @endif/>
