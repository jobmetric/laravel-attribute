                        ...
                        <div class="card card-flush h-xl-100">
                            <div class="card-header pt-7">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-dark">${getLocalize('language.package_core.tabs.connections')}</span>
                                </h3>
                            </div>
                            <div class="card-body pt-2">
                                <div class="row">
                                    <div class="col-12">`
                                        $.each(data.attributeRelations, function(key, relation) {
                                            if (relation.length === 0) {
                                                return
                                            }

                                            if (relation.attributable) {
                                                ...
                                                html += `<div class="col-12">
                                                            <div class="border border-dashed border-hover-secondary p-3">
                                                                <div class="d-flex justify-content-between align-items-center">
                                                                    <div>${relation.attributable_type}</div>
                                                                    <div>${relation.attributable_id}</div>
                                                                </div>
                                                                <div class="d-flex justify-content-between align-items-center">
...
loadScriptsSequentially([
    ...
    $(document).ready(function(){
        dt = $('#datatable').on('preXhr.dt', function (e, settings, data) {
            ...
            ajax: {
                url: getLocalize('attribute_value.route'),
                data: function (data) {
                ...
                // action
                {
                    data: function(e) {
                        return `<div class="d-flex justify-content-center align-items-center">
                                    <a href="${getLocalize('attribute_value.route')}/${e.id}/edit" class="btn btn-sm btn-outline btn-outline-dashed bg-light-success btn-color-gray-800">
