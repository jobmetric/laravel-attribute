...
return [
    ...
    */
    ...
    "types" => [
        "radio" => [
            "name" => "رادیو",
            "description" => "انتخاب تک‌گزینه از بین مقادیر.",
        ],
        "checkbox" => [
            "name" => "چک‌باکس",
            "description" => "امکان انتخاب چند مقدار.",
        ],
        "select" => [
            "name" => "انتخابی",
            "description" => "انتخاب یک مقدار از فهرست کشویی.",
        ],
        "color" => [
            "name" => "رنگ",
            "description" => "مقدار رنگ برای ویژگی.",
        ],
        "card" => [
            "name" => "کارت",
            "description" => "نمایش مقادیر به صورت کارت.",
        ],
        "image" => [
            "name" => "تصویر",
            "description" => "مقدار ویژگی مبتنی بر تصویر.",
        ],
        "input" => [
            "name" => "ورودی",
            "description" => "ورودی متن یا عدد آزاد.",
        ],
    ],
